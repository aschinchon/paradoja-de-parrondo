...
date: "EncuentRo online R-hispano 19/9/2020"
output:
  html_document:
    css: img/base.css
    toc: yes
...
[<img src="./img/jornadas-con-r-hispano-u-tad-web.jpg" width="500">]()
...
Con este experimento hemos visto cosas importantes de R, destacando sobre todo las distintas maneras que hay de iterar: `for`, `replicate`, `apply` y `accumulate`.
